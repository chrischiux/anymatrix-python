...
function test_core_bidiag_alt(testcase)
    A = anymatrix('core/bidiag_alt',3);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',5);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',8);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',10);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',15);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',24);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',25);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',30);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
    A = anymatrix('core/bidiag_alt',31);
    anymatrix_check_props(A, 'core/bidiag_alt', testcase);
end

function test_core_biogeography(testcase)
    A = anymatrix('core/biogeography',3);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',5);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',8);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',10);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',15);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',24);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',25);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',30);
    anymatrix_check_props(A, 'core/biogeography', testcase);
    A = anymatrix('core/biogeography',31);
    anymatrix_check_props(A, 'core/biogeography', testcase);
end

function test_core_blockcirc(testcase)
    A = anymatrix('core/blockcirc',3);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',5);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',8);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',10);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',15);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',24);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',25);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',30);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
    A = anymatrix('core/blockcirc',31);
    anymatrix_check_props(A, 'core/blockcirc', testcase);
end
...
function test_core_circul_binom(testcase)
    A = anymatrix('core/circul_binom',3);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',5);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',8);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',10);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',15);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',24);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',25);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',30);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
    A = anymatrix('core/circul_binom',31);
    anymatrix_check_props(A, 'core/circul_binom', testcase);
end

function test_core_collatz(testcase)
    A = anymatrix('core/collatz',3);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',5);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',8);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',10);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',15);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',24);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',25);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',30);
    anymatrix_check_props(A, 'core/collatz', testcase);
    A = anymatrix('core/collatz',31);
    anymatrix_check_props(A, 'core/collatz', testcase);
end

function test_core_creation(testcase)
    A = anymatrix('core/creation',3);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',5);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',8);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',10);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',15);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',24);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',25);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',30);
    anymatrix_check_props(A, 'core/creation', testcase);
    A = anymatrix('core/creation',31);
    anymatrix_check_props(A, 'core/creation', testcase);
end

function test_core_cross(testcase)
    A = anymatrix('core/cross',3);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',5);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',8);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',10);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',15);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',24);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',25);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',30);
    anymatrix_check_props(A, 'core/cross', testcase);
    A = anymatrix('core/cross',31);
    anymatrix_check_props(A, 'core/cross', testcase);
end
...
function test_core_hess_orth(testcase)
    A = anymatrix('core/hess_orth',3);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',5);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',8);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',10);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',15);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',24);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',25);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',30);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
    A = anymatrix('core/hess_orth',31);
    anymatrix_check_props(A, 'core/hess_orth', testcase);
end

function test_core_hess_sublu(testcase)
    A = anymatrix('core/hess_sublu',3);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',5);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',8);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',10);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',15);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',24);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',25);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',30);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
    A = anymatrix('core/hess_sublu',31);
    anymatrix_check_props(A, 'core/hess_sublu', testcase);
end
...
function test_core_indef(testcase)
    A = anymatrix('core/indef',3);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',5);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',8);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',10);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',15);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',24);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',25);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',30);
    anymatrix_check_props(A, 'core/indef', testcase);
    A = anymatrix('core/indef',31);
    anymatrix_check_props(A, 'core/indef', testcase);
end

function test_core_kms_nonsymm(testcase)
    A = anymatrix('core/kms_nonsymm',3);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',5);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',8);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',10);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',15);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',24);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',25);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',30);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
    A = anymatrix('core/kms_nonsymm',31);
    anymatrix_check_props(A, 'core/kms_nonsymm', testcase);
end

function test_core_milnes(testcase)
    A = anymatrix('core/milnes',3);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',5);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',8);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',10);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',15);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',24);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',25);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',30);
    anymatrix_check_props(A, 'core/milnes', testcase);
    A = anymatrix('core/milnes',31);
    anymatrix_check_props(A, 'core/milnes', testcase);
end

function test_core_nilpot_triang(testcase)
    A = anymatrix('core/nilpot_triang',3);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',5);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',8);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',10);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',15);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',24);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',25);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',30);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
    A = anymatrix('core/nilpot_triang',31);
    anymatrix_check_props(A, 'core/nilpot_triang', testcase);
end

function test_core_nilpot_tridiag(testcase)
    A = anymatrix('core/nilpot_tridiag',3);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',5);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',8);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',10);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',15);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',24);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',25);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',30);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
    A = anymatrix('core/nilpot_tridiag',31);
    anymatrix_check_props(A, 'core/nilpot_tridiag', testcase);
end

function test_core_orthog_cauchy(testcase)
    A = anymatrix('core/orthog_cauchy',3);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',5);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',8);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',10);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',15);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',24);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',25);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',30);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
    A = anymatrix('core/orthog_cauchy',31);
    anymatrix_check_props(A, 'core/orthog_cauchy', testcase);
end

function test_core_perfect_shuffle(testcase)
    A = anymatrix('core/perfect_shuffle',3);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',5);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',8);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',10);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',15);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',24);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',25);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',30);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
    A = anymatrix('core/perfect_shuffle',31);
    anymatrix_check_props(A, 'core/perfect_shuffle', testcase);
end

function test_core_pick(testcase)
    A = anymatrix('core/pick',3);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',5);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',8);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',10);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',15);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',24);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',25);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',30);
    anymatrix_check_props(A, 'core/pick', testcase);
    A = anymatrix('core/pick',31);
    anymatrix_check_props(A, 'core/pick', testcase);
end
...
function test_core_stoch_cesaro(testcase)
    A = anymatrix('core/stoch_cesaro',3);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',5);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',8);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',10);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',15);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',24);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',25);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',30);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
    A = anymatrix('core/stoch_cesaro',31);
    anymatrix_check_props(A, 'core/stoch_cesaro', testcase);
end

function test_core_stoch_compan(testcase)
    A = anymatrix('core/stoch_compan',3);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',5);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',8);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',10);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',15);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',24);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',25);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',30);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
    A = anymatrix('core/stoch_compan',31);
    anymatrix_check_props(A, 'core/stoch_compan', testcase);
end

function test_core_stoch_perfect(testcase)
    A = anymatrix('core/stoch_perfect',3);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',5);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',8);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',10);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',15);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',24);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',25);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',30);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
    A = anymatrix('core/stoch_perfect',31);
    anymatrix_check_props(A, 'core/stoch_perfect', testcase);
end

function test_core_stoch_revtri(testcase)
    A = anymatrix('core/stoch_revtri',3);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',5);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',8);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',10);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',15);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',24);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',25);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',30);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
    A = anymatrix('core/stoch_revtri',31);
    anymatrix_check_props(A, 'core/stoch_revtri', testcase);
end
...
function test_core_tournament(testcase)
    A = anymatrix('core/tournament',8);
    anymatrix_check_props(A, 'core/tournament', testcase);
    A = anymatrix('core/tournament',10);
    anymatrix_check_props(A, 'core/tournament', testcase);
    A = anymatrix('core/tournament',24);
    anymatrix_check_props(A, 'core/tournament', testcase);
    A = anymatrix('core/tournament',30);
    anymatrix_check_props(A, 'core/tournament', testcase);
end

function test_core_triminsval01(testcase)
    A = anymatrix('core/triminsval01',3);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',5);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',8);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',10);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',15);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',24);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',25);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',30);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
    A = anymatrix('core/triminsval01',31);
    anymatrix_check_props(A, 'core/triminsval01', testcase);
end

function test_core_unitary_eye(testcase)
    A = anymatrix('core/unitary_eye',3);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',5);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',8);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',10);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',15);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',24);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',25);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',30);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
    A = anymatrix('core/unitary_eye',31);
    anymatrix_check_props(A, 'core/unitary_eye', testcase);
end

function test_core_uptraporth(testcase)
    A = anymatrix('core/uptraporth',3);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',5);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',8);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',10);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',15);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',24);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',25);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',30);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
    A = anymatrix('core/uptraporth',31);
    anymatrix_check_props(A, 'core/uptraporth', testcase);
end
...
function test_gallery_house(testcase)
    A = anymatrix('gallery/house',3);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',5);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',8);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',10);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',15);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',24);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',25);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',30);
    anymatrix_check_props(A, 'gallery/house', testcase);
    A = anymatrix('gallery/house',31);
    anymatrix_check_props(A, 'gallery/house', testcase);
end
...
function test_gallery_qmult(testcase)
    A = anymatrix('gallery/qmult',3);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',5);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',8);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',10);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',15);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',24);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',25);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',30);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
    A = anymatrix('gallery/qmult',31);
    anymatrix_check_props(A, 'gallery/qmult', testcase);
end
